...
public class SalaryCalculator {
    ...
    public static void main(String[] args) {
        ...
        String taxReport = "State tax rate: " + stateTax + ", Federal tax rate: " + federalTax + ",  Base Salary $" +
                salary + ",\nTax amount: " + stateTax + " state tax and" + federalTax + " for federal tax, " +
                "in total it is " + totalTax + "\nAfter tax our salary is: " + salaryAfterTax;
